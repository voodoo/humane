      ...
      <div className="mx-auto flex w-full max-w-3xl flex-1 flex-col px-4 py-8 sm:px-6 sm:py-10">
        <div className="mx-auto w-full max-w-xl">
          ...
          <header className="mb-6">
            ...
            <p className="mt-2 text-muted">One form for {monthLabel}</p>
          </header>
          ...
          {submitted ? (
            <div className="rounded-lg border border-accent/30 bg-accent-soft p-6">
              ...
              <p className="mt-2 text-sm text-foreground">
                ...
                browser will remember your details next time you open the email
                link.
              </p>
              <button
                type="button"
            ...
            >
              ...
              <div className="rounded-md border border-border bg-accent-soft/50 p-3 text-sm">
                ...
                <p className="text-muted">
                  One signup covers this month’s orientation offerings at Main
                  Shelter.
                </p>
              </div>
